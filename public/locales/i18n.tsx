  ...
  en: {
    translation: {
      centerLeaderInfo: {
        ...
        education2:
          "Master Degree at Yonsei University(Educational Statistics)",
        education3: "Ph.D at UC Berkeley(Educational Measurement / Evaluation)",
      },
      viceCenterLeaderInfo: {
        viceCenterLeader: "부센터장",
        name: "임황규",
        affiliation: "소속 및 직함",
        affiliation_now: "인하대학교 교육학과 교수",
        career: "주요 경력",
        ex_career1: "(전) 한국교육과정평가원, 전문연구원",
        ex_career2:
            "(전) Graduate Management Admission Council, Psychometrician",
        now_career1: "(현) 인하대학교 교육학과 교수",
        education_title: "학력",
        education1: "연세대학교 학사 (교육학)",
        education2: "연세대학교 석사 (측정평가 전공)",
        education3: "University of Massachusetts Amherst 박사 (교육 측정)",
      },
